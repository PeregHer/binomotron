...
class MySQL_link:
    ...
    def __init__(self):
        self.link = mysql.connect(host='localhost', password='ISEN', user='ISEN', database='binomotron')
...
# Créatio nde la fenetre Tkinter
window = tkinter.Tk()
window.title('Binômotron')
window.geometry('800x500')
window.configure(bg='#e5001c')
window.resizable(width=False, height=False)

# Nom du projet
binomotron_label = tkinter.Label(font=('Helvetica', '50'), fg='black', bg='#e5001c', text="Binômotron")
binomotron_label.place(x=230, y=25)

# Noms des createurs du projet
nom_pereg = tkinter.Label(font=('Helvetica', '15'), fg='black', bg='#e5001c', text="Pereg Hergoualc'h")
nom_pereg.place(x=10, y=470)
nom_baptiste = tkinter.Label(font=('Helvetica', '15'), fg='black', bg='#e5001c', text="Baptiste Le Berre")
